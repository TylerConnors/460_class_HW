...
namespace Final460Take2.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MovieID,Title,Year,DirectorID")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MovieID,Title,Year,DirectorID")] Movie movie)
        {
            if (ModelState.IsValid)
            {
